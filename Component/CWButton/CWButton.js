...
//     return out;
// }
// var Identifier = '382687921502'; //充电器识别码固定值
// var batteryIdentifier = '03aa382687921502'; //电池识别码固定值
// var chargerIdentifier = '02aa382687921502'; //充电器识别码固定值
//
// var phoneArray;
// var BleData;
...
import CWEchart from '../CWSvg/CWEchart';
import TAB from '../CWSvg/TAB';
...
export default class CWButton extends Component {
    ...
    //
    //     // 充电器
    //     let chargerArray=new Promise(function (resolve, reject) {
    ...
    //
    //     // 电池
    //     let batteryArray=new Promise(function (resolve,reject) {
    ...
    //     );
    //
    //     Promise.all([chargerArray,batteryArray]).then((values) => {
    //         phoneArray = [].concat.apply([], values);//绑定电池与充电器合并后的数组
    //
    //         //开启数据库
    //         if(!db){
    //             db = sqLite.open();
    ...
    //                             if (batteryIdentifier === Identifier && phoneArray !== undefined) {//确认识别码
    //                                 for (var r=0;r<phoneArray.length;r++){
    //                                     if(phoneArray[r] === batteryID){
    //                                         // 模拟数据
    //                                         var batteryData = [];
    //                                         var battery = {};
    //                                         battery.charger_id = batteryID;//设备id
            ...
            <ScrollView >
                <View style={styles.BtnsStyle}>
                    <View>
                        ...
                        <CWBtnCell
                            title='充电记录'
                            // onPress={()=>this.props.navigation.navigate('CWEchart')}
                        />
