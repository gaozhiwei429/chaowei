                ...
                <View style={styles.confirmModal}>
                    <View style={styles.confirm}>
                        ...
                        <View style={styles.btn}>
                            <TouchableOpacity underlayColor='#eee' onPress={this._onLeftPress} style={styles.btnClick}>
                                <View style={[styles.btnView, styles.btnLeft]}>
                                    <Text style={styles.btnText}>{this.props.btnLeftText}</Text>
                                </View>
                            </TouchableOpacity>
                            <TouchableOpacity underlayColor='#eee' onPress={this._onRightPress} style={styles.btnClick}>
