        ...
        const loop =()=>{
            ...
            new Promise(function (resolve,reject){
                ...
                const battery1 = Database.map((item,i)=>{
                    if(batteryBind[0][0]==Database[i].battery_id){
                        return item
                    }
                ...
                const battery2 = Database.map((item,i)=>{
                    if(batteryBind[0][1]==Database[i].battery_id){
                        return item
                    }
                }).filter(function(val){//过滤掉undefined
                    return !(!val || val === "");
                ...
                const battery3 = Database.map((item,i)=>{
                    if(batteryBind[0][2]==Database[i].battery_id){
                        return item
                    }
                }).filter(function(val){//过滤掉undefined
                    return !(!val || val === "");
                ...
                const battery4 = Database.map((item,i)=>{
                    if(batteryBind[0][3]==Database[i].battery_id){
                        return item
                    }
                }).filter(function(val){//过滤掉undefined
                    return !(!val || val === "");
                ...
                const battery5 = Database.map((item,i)=>{
                    if(batteryBind[0][4]==Database[i].battery_id){
                        return item
                    }
                }).filter(function(val){//过滤掉undefined
                    return !(!val || val === "");
                ...
                const battery6 = Database.map((item,i)=>{
                    if(batteryBind[0][5]==Database[i].battery_id){
                        return item
                    }
                }).filter(function(val){//过滤掉undefined
                    return !(!val || val === "");
